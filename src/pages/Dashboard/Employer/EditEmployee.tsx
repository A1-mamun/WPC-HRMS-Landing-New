...
import { useGetOrgainsationHCMMasterQuery } from "../../../redux/features/employer/createOrganisation";
const EditEmployee = () => {
  const { id } = useParams();
  ...
  const { data, isError, isLoading, refetch } =
    useGetOrgainsationHCMMasterQuery(undefined);
              ...
              <div className="pt-5">
                ...
                <div className="grid grid-cols-4 gap-5 pt-5">
                  ...
                  <RHFSelect
                    ...
                    options={data?.data?.designations || []}
                  />
                  ...
                  <RHFSelect
                    ...
                    options={data?.data?.employmentTypes || []}
                  />
                      ...
                      <tr key={index}>
                        ...
                        <td className="border p-2">
                          <input
                            ...
                            className="w-full p-1 border rounded"
                            {...register(
                              `educationalDetails.${index}.percentage`
                            )}
                          />
                      ...
                      <div className="grid grid-cols-4 gap-5 mt-4">
                        <div className="col-span-1 relative">
                          ...
                          <textarea
                            ...
                            rows={3}
                            {...register(
                              `jobDetails.${index}.responsibilities`
                            )}
                          />
                      ...
                      <div className="grid grid-cols-3 gap-5 mt-4">
                        <div className="col-span-2 relative">
                          ...
                          <textarea
                            ...
                            rows={3}
                            {...register(
                              `trainingDetails.${index}.description`
                            )}
                          />
                    ...
                    <div key={index} className="mb-5">
                      <div className="grid grid-cols-4 gap-5">
                        ...
                        <RHFDatepicker
                          ...
                          label="Issue Date"
                          error={
                            errors.otherDetails?.[index]?.issueDate?.message
                          }
                        />
                        ...
                        <RHFFileInput
                          ...
                          label="Document"
                          error={
                            errors.otherDetails?.[index]?.document?.message
                          }
                        />
              ...
              <div className="pt-5">
                ...
                <div className="grid grid-cols-3 gap-5 pt-5">
                  ...
                  <RHFSelect
                    ...
                    options={data?.data?.wedgesPayModes || []}
                  />
                  ...
                  <RHFSelect
                    ...
                    options={data?.data?.paymentTypes || []}
                  />
                  ...
                  <RHFSelect
                    ...
                    options={data?.data?.bankSortCodes || []}
                  />
