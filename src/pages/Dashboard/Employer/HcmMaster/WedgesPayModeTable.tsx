...
const WedgesPayModeTable = () => {
  ...
  const [createWedgesPayMode] = useCreateOrganisationWedgesPayModeMutation();
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      await createWedgesPayMode({ data: { name } }).unwrap();
      toast.success("Wedges Pay Mode created successfully!", {
        id: toastId,
        duration: 2000,
      });
      onOpenChange();
      ...
      toast.error("Failed to create Wedges Pay Mode.", {
        id: toastId,
        duration: 3000,
      });
    }
      ...
      <div className="flex justify-between py-3">
        ...
        <div>
          ...
          <HCMModal
            ...
            title="Add Wedges Pay Mode"
            placeholder="Enter wedges pay mode name"
          />
        </div>
      </div>
