...
import { useGetOrganisationEmploymentTypesQuery } from "../../../../redux/features/employer/hcmMaster";

const EmploymentTypeTable = () => {
  const { data, isLoading, isError, refetch, isFetching } =
    useGetOrganisationEmploymentTypesQuery(undefined);
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[222px]">
        <Spinner
          ...
          aria-label="Loading employment types"
        />
  ...
  if (data?.data?.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[222px]">
        <p className="text-gray-600 text-lg">No employment types found</p>
      </div>
    );
  }
