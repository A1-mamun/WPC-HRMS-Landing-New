...
export const updateOrgDocumentsSchema = z.object({
  ...
  keyPersonPhoneNo: z.string().min(1, { message: "Phone number is required" }),
  keyPersonEmail: z
    .string({ required_error: "Email is required" })
    .min(1, "Email is required")
    .email({
  ...
  level1PersonProofOfId: z
    ...
    .optional(),
  level1PersonCriminalHistory: z.enum(["Yes", "No"] as [string, ...string[]], {
    required_error: "Criminal history is required",
  }),
...
export type EmployerUpdateFormSchemaType = z.infer<
  typeof updateOrgDocumentsSchema
>;
